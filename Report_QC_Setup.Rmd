...
There are 7127 genes in the gtf-file and a annotation file is created using org.Sc.sgd.db in script 02_CreateAnnotation.R and saved as Annotation.csv.\
In the annotation file and in tibbles and csv-files gene standard name is GeneName and gene systematic name is GeneID In 01_Lengthcomparison.R gene and exon lengths and gene-order were safety-checked to be identical for all samples. Gene length is checked and is never shorter than exon length.\
File: QC_GenerateIntronRatios.R Genes with more than 50 counts in all samples. Out of 7127 genes to 4777 remains in Plus50CountGenes.csv
