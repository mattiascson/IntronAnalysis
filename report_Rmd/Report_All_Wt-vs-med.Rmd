---
title: Splice ratio comparison between Wt and all med mutants for all intron genes.
...
source(file = "../script_R/07_Compare_All_Wt-vs-med_0h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_0h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_2h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_2h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_4h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_4h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_6h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/07_Compare_All_Wt-vs-med_6h_Debatch.R", local = knitr::knit_global())
```
