---
title: Splice ratio comparison between Wt and all med mutants for mediator associated intron genes.
...
-   Results
    ...
    -   The semi-general pattern is that med9 and cdk8 have some percent higher splice ratio then Wt, and med16 and med18 equal or lower, if one takes into account that results have to have the same trend between debatched and non-debatched to be considered significant. This seems to apply looking at either mediator associated, other or all mediator genes, at all time points.
...
source(file = "../script_R/08_Compare_Med_Wt-vs-med_0h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_0h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_2h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_2h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_4h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_4h_Debatch.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_6h.R", local = knitr::knit_global())
```
...
```{r, echo = FALSE, results = 'hide', warning = FALSE, message = FALSE, fig.align='center', out.width = '100%', fig.width = 12, fig.asp = 0.7}
source(file = "../script_R/08_Compare_Med_Wt-vs-med_6h_Debatch.R", local = knitr::knit_global())
```
