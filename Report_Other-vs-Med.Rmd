...
-   Results
    ...
    -   There is generally a small few % difference between mediator and other intron genes average splice ratios at all time points and in all genotypes.
    -   Corrected p-Values for multiple testing are in Table.1 and, but lesser difference (p-value \> 0.05) in med16 and med18 at 6h.
