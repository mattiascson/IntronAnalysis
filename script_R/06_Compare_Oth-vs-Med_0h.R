...
#Create vector to store pvalues 
pValues <- vector(mode = "numeric")

#####Wt
###Check Mediator intron genes.
WtMedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("Wt"))%>% select(contains("30C")) %>% select(contains("0h"))
...
WtOthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("Wt"))%>% select(contains("30C")) %>% select(contains("0h"))
...
boxplot(WtOthRelExon[["Mean"]],WtMedRelExon[["Mean"]], main=paste("SpliceRatio Wt 30C 0h. t.test pval", MediatorOther), names=c(paste(nOther, "Other u", MeanOther),paste(nMediator, " Mediator u", MeanMediator)))
pValues <- c(pValues,MediatorOther)


#####med9
###Check Mediator intron genes.
med9MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med9"))%>% select(contains("30C")) %>% select(contains("0h"))
...
###Check Other intron genes.
med9OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med9"))%>% select(contains("30C")) %>% select(contains("0h"))
...
boxplot(med9OthRelExon[["Mean"]],med9MedRelExon[["Mean"]], main=paste("SpliceRatio med9 30C 0h. t.test pval", MediatorOther), names=c(paste(nOther, "Other u", MeanOther),paste(nMediator,"Mediator u", MeanMediator)))
pValues <- c(pValues,MediatorOther)


#####cdk8
###Check Mediator intron genes.
cdk8MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("cdk8"))%>% select(contains("30C")) %>% select(contains("0h"))
...
###Check Other intron genes.
cdk8OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("cdk8"))%>% select(contains("30C")) %>% select(contains("0h"))
...
boxplot(cdk8OthRelExon[["Mean"]],cdk8MedRelExon[["Mean"]], main=paste("SpliceRatio cdk8 30C 0h. t.test pval", MediatorOther), names=c(paste(nOther, "Other u", MeanOther),paste(nMediator,"Mediator u", MeanMediator)))
pValues <- c(pValues,MediatorOther)


#####med16
###Check Mediator intron genes.
med16MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med16"))%>% select(contains("30C")) %>% select(contains("0h"))
...
###Check Other intron genes.
med16OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med16"))%>% select(contains("30C")) %>% select(contains("0h"))
...
boxplot(med16OthRelExon[["Mean"]],med16MedRelExon[["Mean"]], main=paste("SpliceRatio med16 30C 0h. t.test pval", MediatorOther), names=c(paste(nOther, "Other u", MeanOther),paste(nMediator,"Mediator u", MeanMediator)))
pValues <- c(pValues,MediatorOther)


#####med18
###Check Mediator intron genes.
med18MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med18"))%>% select(contains("30C")) %>% select(contains("0h"))
...
###Check Other intron genes.
med18OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med18"))%>% select(contains("30C")) %>% select(contains("0h"))
...
boxplot(med18OthRelExon[["Mean"]],med18MedRelExon[["Mean"]], main=paste("SpliceRatio med18 30C 0h. t.test pval", MediatorOther), names=c(paste(nOther, "Other u", MeanOther),paste(nMediator,"Mediator u", MeanMediator)))
pValues <- c(pValues,MediatorOther)
