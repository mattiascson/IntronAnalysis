...
WtRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("Wt"))%>% select(contains("30C")) %>% select(contains("6h"))
...
med9RelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med9"))%>% select(contains("30C")) %>% select(contains("6h"))
...
boxplot(WtRelExon[["Mean"]],med9RelExon[["Mean"]], main=paste("SpliceRatio Oth Wt vs med9 30C 6h. t.test pair pval", Wtmed), names=c(paste(nWt, "Wt u", MeanWt),paste(nmed9, " med9 u", Meanmed9)))
...
WtRelExon <- tibble(AllIntronGenes  %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(GeneID,GeneName,LengthDiff),WtRelExon)
###Check Mediator intron genes.
cdk8RelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("cdk8"))%>% select(contains("30C")) %>% select(contains("6h"))
...
boxplot(WtRelExon[["Mean"]],cdk8RelExon[["Mean"]], main=paste("SpliceRatio Oth Wt vs cdk8 30C 6h. t.test pair pval", Wtmed), names=c(paste(nWt, "Wt u", MeanWt),paste(ncdk8, " cdk8 u", Meancdk8)))
pValues <- c(pValues,Wtmed)
...
WtRelExon <- tibble(AllIntronGenes  %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(GeneID,GeneName,LengthDiff),WtRelExon)
###Check Mediator intron genes.
med16RelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med16"))%>% select(contains("30C")) %>% select(contains("6h"))
...
boxplot(WtRelExon[["Mean"]],med16RelExon[["Mean"]], main=paste("SpliceRatio Oth Wt vs med16 30C 6h. t.test pair pval", Wtmed), names=c(paste(nWt, "Wt u", MeanWt),paste(nmed16, " med16 u", Meanmed16)))
pValues <- c(pValues,Wtmed)
...
WtRelExon <- tibble(AllIntronGenes  %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(GeneID,GeneName,LengthDiff),WtRelExon)
###Check Mediator intron genes.
med18RelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med18"))%>% select(contains("30C")) %>% select(contains("6h"))
...
boxplot(WtRelExon[["Mean"]],med18RelExon[["Mean"]], main=paste("SpliceRatio Oth Wt vs med18 30C 6h. t.test pair pval", Wtmed), names=c(paste(nWt, "Wt u", MeanWt),paste(nmed18, " med18 u", Meanmed18)))
pValues <- c(pValues,Wtmed)