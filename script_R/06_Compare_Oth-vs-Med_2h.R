...
#png(file=paste("./Outpng/", Date,"_mut-vs-Wt_2h.png",sep=""), width=10.69, height=7.27, units="in", res=100)
...
WtMedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("Wt"))%>% select(contains("30C")) %>% select(contains("2h"))
...
WtOthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("Wt"))%>% select(contains("30C")) %>% select(contains("2h"))
...
#####med9
###Check Mediator intron genes.
med9MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med9"))%>% select(contains("30C")) %>% select(contains("2h"))
...
###Check Other intron genes.
med9OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med9"))%>% select(contains("30C")) %>% select(contains("2h"))
...
#####cdk8
###Check Mediator intron genes.
cdk8MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("cdk8"))%>% select(contains("30C")) %>% select(contains("2h"))
...
###Check Other intron genes.
cdk8OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("cdk8"))%>% select(contains("30C")) %>% select(contains("2h"))
...
#####med16
###Check Mediator intron genes.
med16MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med16"))%>% select(contains("30C")) %>% select(contains("2h"))
...
###Check Other intron genes.
med16OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med16"))%>% select(contains("30C")) %>% select(contains("2h"))
...
#####med18
###Check Mediator intron genes.
med18MedRelExon <- AllIntronGenes %>% filter(GeneID %in% MediatorGenes[["GeneID"]]) %>% select(contains("med18"))%>% select(contains("30C")) %>% select(contains("2h"))
...
###Check Other intron genes.
med18OthRelExon <- AllIntronGenes %>% filter(GeneID %in% OtherIntronGenes[["GeneID"]]) %>% select(contains("med18"))%>% select(contains("30C")) %>% select(contains("2h"))
